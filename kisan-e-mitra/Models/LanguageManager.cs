...
namespace KisanEMitra.Models
{
    ...
    public class LanguageManager
    {
        public static List<LanguageInfo> AvailableLanguages = new List<LanguageInfo> {
            ...
            new LanguageInfo {
                LanguageEnglishLabel = "English", LanguageCultureLabel = "English",  LanguageCultureCode = "en", Position = 11, LanguageFirstAlphabet = "A"
            },
            new LanguageInfo {
            ...
            new LanguageInfo {
                LanguageEnglishLabel = "Assamese", LanguageCultureLabel = "অসমীয়া", LanguageCultureCode = "as", Position = 12, LanguageFirstAlphabet = "অ"
            },
        };
